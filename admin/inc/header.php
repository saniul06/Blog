    ...
    <div class="container_12">
        ...
        <div class="grid_12">
            <ul class="nav main">
                ...
                <?php
                $query = "select * from tbl_contact where status = 0";  //SHOWING NEW MESSAGE
                ...
                <!-- GIVE ADD USER ACCESS TO ONLY ADMIN -->
                <li class="ic-charts"><a href="adduser.php"><span>Add User</span></a></li>
                <?php }?>
                <li class="ic-charts"><a href="userlist.php"><span>User List</span></a></li>
                <li class="ic-charts"><a href="theme.php"><span>Change Theme</span></a></li>
            </ul>
        </div>
        <div class="clear">
        </div>